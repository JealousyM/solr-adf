package by.perevertkin.solr.view.utils;
...
public class JSFUtils {
    ...
    */
    ...
    private static ResourceBundle getBundle() {
        ...
        return ResourceBundle.getBundle(ctx.getApplication().getMessageBundle(),
                                        locale, ldr);
        //        return BundleFactory.getBundle("com.prognoz.dfa.book.view.ViewControllerBundle");
    }
    ...
    */
     ...
     * @return
     */
    public static BlobDomain createBlobDomain(InputStream in) {
